...
class Punto4Screen extends StatefulWidget {
  const Punto4Screen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _Punto4ScreenState createState() => _Punto4ScreenState();
}

class _Punto4ScreenState extends State<Punto4Screen> {
  ...
  void initState() {
    ...
    _puntoFuture = FirebaseFirestore.instance
        ...
        .doc(
            'hol1jcscnvUuszhkD4Wa') // ID del documento correspondiente a Punto #4
        .get();
  }

  void _launchURL(url) async {
    const url =
        'https://maps.app.goo.gl/pWQbJF3kqsUB1fPQ8'; // URL de ubicación para Punto #4
