...
class Tip4Screen extends StatefulWidget {
  const Tip4Screen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _Tip4ScreenState createState() => _Tip4ScreenState();
}
...
class _Tip4ScreenState extends State<Tip4Screen> {
  ...
  void initState() {
    ...
    _tipFuture = FirebaseFirestore.instance
        .collection('Tips')
        .doc('WbZ6PIfkayHZBNAGUpYC')
        .get();
    _videoController = VideoPlayerController.asset('assets/videos/Tip4.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
