...
class Tip5Screen extends StatefulWidget {
  const Tip5Screen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _Tip5ScreenState createState() => _Tip5ScreenState();
}
...
class _Tip5ScreenState extends State<Tip5Screen> {
  ...
  void initState() {
    ...
    _tipFuture = FirebaseFirestore.instance
        .collection('Tips')
        .doc('X01E9991LpDW7GRUo8z3')
        .get();
    _videoController = VideoPlayerController.asset('assets/videos/Tip5.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
